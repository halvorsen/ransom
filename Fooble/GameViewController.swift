...
class GameViewController: UIViewController {
    ...
    var currentScoreString = String() {didSet{score.text = currentScoreString + "/" + goalScoreString}}
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        for i in 0..<67 {
            ...
            switch myShuffleAndDeal.whatColorIsCard(card: Int(deck[i])) {
            case .blue: //blue
            ...
            dotLabels[i].text = String(Int(deck[i]%7) + 1)
    ...
    var priorIndex = Int()
    var lastIndex = Int() {didSet{print("lastindex: \(lastIndex)")}}
        ...
        if gesture.state == UIGestureRecognizerState.changed {
            ...
            if self.displayLabels[0].isDescendant(of: self.view) {
                ...
                for i in futureIndexes {
                    print("3")
                    if shapeLayers2[i].path!.contains(locationOfPan) && dotLabels[i].isDescendant(of: self.view) && (lastCardDisplayed != Int(deck[i])) {
                        print("4")
                        ...
                        displayLabels[count].text = String(Int(deck[i]%7) + 1)
                        lastCardDisplayed = Int(deck[i])
                        ...
                        print("priorIndex: \(priorIndex)")
                        print("potentialFutureIndex: \(potentialFutureIndex)")
    ...
    private func addButtons() {
        ...
        scoreFlash.textColor = UIColor(red: 215/255, green: 215/255, blue: 215/255, alpha: 1.0)
        scoreFlash.textAlignment = NSTextAlignment.center
        scoreFlash.font = UIFont(name: "HelveticaNeue-Bold", size: fontSizeMultiplier*100)
        ...
        sequenceRowTwo.text = "50/n100/n150/n500/n750/n1500/n2500/n3500/n10,000/n25,000/n50,000/n"
